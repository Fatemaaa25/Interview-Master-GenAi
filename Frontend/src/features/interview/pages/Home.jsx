...
const Home = () => {
  ...
  const handleGenerateReport = async () => {
    ...
    // Check Resume OR Self Description
    if (!resumeFile && !selfDescription.trim()) {
      setFormError(
        "Please upload your resume or provide a self-description before generating your interview strategy.",
      );
      return;
    }
    ...
    try {
      ...
      setFormError(
        "Something went wrong while generating your interview strategy. Please try again.",
      );
    }
  };
              ...
              <label className="dropzone" htmlFor="resume">
                {selectedResume ? (
                  <>
                    ...
                    <p className="dropzone__subtitle">{selectedResume.name}</p>
